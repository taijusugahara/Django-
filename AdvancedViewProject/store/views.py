from django.shortcuts import redirect, render,redirect,get_object_or_404,get_list_or_404
...
def one_item(request): #関数redirect
  return redirect('store:item_detail', id =1)

def page_not_found(request, exception):
  return render(request, 'store/404.html', status=404)
  # return render(request,'store:item_detail', id =1)
