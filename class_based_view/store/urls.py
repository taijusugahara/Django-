...
from .views import (BookCreateView, BookDetailView, IndexView, HomeView, BookDetailView,
...
urlpatterns =[
  ...
  path('edit_book/<int:pk>', BookUpdateView.as_view(), name="edit_book"), #idじゃだめ pk
